...
with st.sidebar:
    ...
    index=1,
    help="""
    **Equivalencia con el sistema español (ECTS):**
    
    En el Reino Unido se usa el sistema CATS. Para entenderlo en España, simplemente **divide entre 2**:
    
    * **30 cr.** = 15 ECTS (Carga reducida)
    * **60 cr.** = 30 ECTS (Medio curso / Un cuatrimestre)
    * **120 cr.** = 60 ECTS (Un curso completo estándar)
    * **240 cr. o más** = Carga académica muy alta (Equivale a 2 o más años en uno solo).
    
    *Nota: El valor indica la presión de estudio del alumno en el momento actual.*
    """
)
